...
const AVAILABLE_METRICS = {
  meta: [
    ...
    { key: 'leads', name: 'Leads (Pixel + Mensagens)', icon: Target, category: 'Conversões' },
    { key: 'cost_per_lead', name: 'Custo por Lead', icon: DollarSign, category: 'Conversões' },
    { key: 'results', name: 'Resultados (Objetivo)', icon: Target, category: 'Conversões' },
    { key: 'cost_per_result', name: 'Custo por Resultado', icon: DollarSign, category: 'Conversões' },
    { key: 'form_leads', name: 'Formulários (Lead Ads)', icon: Target, category: 'Conversões' },
    { key: 'cost_per_form_lead', name: 'Custo por Formulário', icon: DollarSign, category: 'Conversões' },
    { key: 'message_leads', name: 'Mensagens', icon: Target, category: 'Conversões' },
    { key: 'cost_per_message', name: 'Custo por Mensagem', icon: DollarSign, category: 'Conversões' },
    { key: 'link_clicks', name: 'Cliques no Link', icon: MousePointer, category: 'Conversões' },
    { key: 'cost_per_link_click', name: 'Custo por Clique no Link', icon: DollarSign, category: 'Conversões' },
    ...
    { key: 'add_to_cart', name: 'Adicionar ao Carrinho', icon: ShoppingCart, category: 'Pixel' },
    { key: 'cost_per_add_to_cart', name: 'Custo por Carrinho', icon: DollarSign, category: 'Pixel' },
    { key: 'initiate_checkout', name: 'Iniciar Checkout', icon: ShoppingCart, category: 'Pixel' },
    { key: 'cost_per_checkout', name: 'Custo por Checkout', icon: DollarSign, category: 'Pixel' },
    { key: 'view_content', name: 'Visualização de Conteúdo', icon: EyeIcon, category: 'Pixel' },
    { key: 'cost_per_view_content', name: 'Custo por Visualização', icon: DollarSign, category: 'Pixel' },
    { key: 'complete_registration', name: 'Registros Completos', icon: Users, category: 'Pixel' },
