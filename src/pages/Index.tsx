...
const features = [
  {
    ...
    description:
      "Visualize Meta Ads e Google Ads lado a lado. Métricas consolidadas em tempo real sem precisar alternar entre plataformas.",
  ...
  },
  {
    ...
    description:
      "Regras automáticas para pausar campanhas, ajustar orçamentos e alertas quando o ROAS cair abaixo do target.",
  ...
  },
  {
    ...
    description: "Notificações imediatas por WhatsApp ou email quando métricas críticas mudam.",
    color: "var(--primary)",
    size: "sm",
  },
  {
    ...
    description:
      "Gere PDFs personalizados para clientes com sua marca. Agendamento semanal ou mensal com um clique.",
    color: "var(--meta)",
    size: "md",
  },
  {
    icon: Shield,
    title: "Dados Seguros",
    description: "Acesso OAuth2 somente leitura. Seus dados não são vendidos ou compartilhados.",
    color: "var(--success)",
    size: "sm",
  },
  {
    icon: Users,
    title: "Multi-cliente",
    description: "Gerencie todas as contas de clientes em um único login. Perfeito para agências.",
    color: "var(--google)",
    size: "sm",
  },
];
...
const testimonials = [
  {
    ...
    text: "Reduzi o tempo de relatórios de 6 horas para 20 minutos. O dashboard unificado mudou minha rotina completamente.",
    stars: 5,
  },
  {
    name: "Rafael Torres",
    role: "CMO",
    company: "E-commerce BrindeMais",
    text: "Finalmente consegui enxergar o ROAS real consolidado entre Meta e Google. Identificamos onde estava perdendo dinheiro em 2 dias.",
    stars: 5,
  },
  {
    name: "Amanda Lima",
    role: "Diretora de Marketing",
    company: "SaaS Contabilizei",
    text: "Os alertas automáticos salvaram nossas campanhas várias vezes. Recomendo para qualquer equipe que invista em mídia paga.",
    stars: 5,
  },
];

/* ── Brands (logos simuladas) ── */
const brands = [
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative overflow-hidden marquee-track">
          <div className="flex gap-12 animate-marquee whitespace-nowrap marquee-content">
            {brands.map((brand, i) => (
              <span
                key={i}
                className="text-sm font-semibold text-muted-foreground/50 hover:text-muted-foreground transition-colors shrink-0 flex items-center gap-2"
              >
      ...
      <section id="features" className="py-32 relative">
        {/* Radial top */}
        <div
          className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] pointer-events-none opacity-10"
          ...
          <Reveal>
            <div className="text-center mb-16 max-w-2xl mx-auto">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                Do relatório ao alerta automático, o AdsInsight cobre todo o ciclo de gestão de campanhas.
              </p>
            </div>
          </Reveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map(({ icon: Icon, title, description, color }, i) => (
              <Reveal key={title} delay={i * 80}>
                <div className="group h-full rounded-xl border border-border bg-[hsl(var(--surface))] p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[hsl(var(--border)/1.8)] hover:shadow-card-hover cursor-default">
                  <div
                    className="w-11 h-11 rounded-xl flex items-center justify-center mb-5 transition-shadow duration-300 group-hover:shadow-glow-primary"
        ...
        <div className="container mx-auto max-w-3xl px-6 text-center relative">
          <Reveal>
            ...
            <p className="text-lg text-muted-foreground mb-10 leading-relaxed">
              Conecte suas contas em menos de 5 minutos. Sem cartão de crédito. Sem complicação.
            </p>
        ...
        <div className="container mx-auto max-w-7xl px-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-8 border-t border-border">
            <p className="text-xs text-muted-foreground">
              © {new Date().getFullYear()} AdsInsight. Todos os direitos reservados.
            </p>
